            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-header border-bottom">
                        {{ isset($data) && isset($data->id) ? 'Edit Publisher' : 'Create Publisher' }}
                    </div>
                    <div class="card-body">
                        <form action="{{ route('admin.publishers.store') }}" method="POST" enctype="multipart/form-data" id="basic-form">
                            @csrf
                                ...
                                <div class="form-group col-md-6">
                                    <div class="mt-3">
                                        <span class="pip" data-title="{{$data->image}}">
                                            <img src="{{ url(config('app.publisher_image')).'/'.$data->image ?? '' }}" alt="" width="150" height="100">
                                        </span>
                                    </div>
                                </div>
                                @endif
