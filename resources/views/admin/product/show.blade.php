                    ...
                    <div class="card-body">
                        <div class="mb-2">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="p-3 listViewclr">  
                                        <h6 class="fw-bolder">Sub categories</h6>
                                        <p class="mb-0">{{ (isset($data) && isset($data->subCategories)) ? $data->subCategories()->pluck('name')}}</p>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="p-3 listViewclr">
                                        ...
                                        @if(!empty($data->main_image))
                                            <div class="even mt-3">
                                                <div class="parc">
                                                    <span class="pip" data-title="{{$data->main_image}}">
                                ...
                                <div class="col-md-12">
                                    <div class="p-3 listViewclr">  
                                        ...
                                        <p class="mb-0">{!! $data->discription ?? '-' !!}</p>
                                    </div>
                                </div>
